...
export default function RekapPengeluaranScreen() {
  ...
  // Filter cashier products from central store for the selected day/week/month (Pengeluaran only)
  const filteredProducts = transactions.filter(
    (item) => item.dayId === selectedDayId && item.transactionType === 'OUT'
  );

  const totalExpenseSelectedDay = filteredProducts.reduce((acc, curr) => acc + curr.total, 0);
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.metricsRow}>
              ...
              <View style={styles.metricColumn}>
                ...
                <Text style={styles.metricExpenseValue}>▼ {formatRupiah(totalExpenseSelectedDay)}</Text>
              </View>
            </View>
          </View>
        </SafeAreaView>
        ...
        <View style={styles.dropdownSection}>
          ...
          >
            <View style={styles.dropdownTriggerLeft}>
              <Ionicons name="funnel-outline" size={18} color="#FA6B6C" style={{ marginRight: 10 }} />
              ...
              {(['Hari', 'Minggu', 'Bulan'] as const).map((periodOption) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && <Ionicons name="checkmark-circle" size={18} color="#FA6B6C" />}
                  </TouchableOpacity>
                );
              })}
            </View>
              ...
              <View style={styles.tableModalContent}>
                ...
                <View style={styles.modalHeaderRow}>
                  <View style={styles.modalHeaderTitleBox}>
                    <Ionicons name="receipt" size={24} color="#FA6B6C" style={{ marginRight: 8 }} />
                    <View>
                      <Text style={styles.modalHeaderTitle}>Tabel Rekap Pengeluaran</Text>
                  ...
                  {filteredProducts.length > 0 ? (
                    <View style={styles.posTableCardModal}>
                      ...
                      <View style={styles.posTableHeader}>
                        <Text style={[styles.posTh, { flex: 2.2 }]}>Barang / Item</Text>
                      ...
                      {filteredProducts.map((prod, idx) => (
                        ...
                        >
                          ...
                          <Text style={[styles.posTd, { flex: 1.6, textAlign: 'right', fontWeight: '800', color: '#EF4444' }]}>
                      ...
                      <View style={styles.posTableFooter}>
                        ...
                        <View style={{ flex: 2.9, alignItems: 'flex-end' }}>
                          <Text style={styles.footerTotalAmountText}>
                            {formatRupiah(totalExpenseSelectedDay)}
                          </Text>
                        </View>
                      </View>
                    </View>
                    ...
                    <View style={styles.emptyModalBox}>
                      ...
                      <Text style={styles.emptyModalTitle}>Belum Ada Rekap Pengeluaran</Text>
                      <Text style={styles.emptyModalSub}>
                        Tidak ada transaksi barang pengeluaran pada{' '}
